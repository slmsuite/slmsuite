...
SLM_Disp_GrayScale.__doc__ = """SLM_Disp_GrayScale(DWORD DisplayNumber, DWORD Flags, USHORT GrayScale)"""
...
SLM_Disp_ReadBMP.__doc__ = """SLM_Disp_ReadBMP(DWORD DisplayNumber, DWORD Flags, LPCWSTR FileName)"""
...
SLM_Disp_ReadCSV.__doc__ = """SLM_Disp_ReadCSV(DWORD DisplayNumber, DWORD Flags, LPCWSTR FileName)"""
...
SLM_Disp_ReadBMP_A.__doc__ = """SLM_Disp_ReadBMP_A(DWORD DisplayNumber, DWORD Flags, LPCSTR FileName)"""
...
SLM_Disp_ReadCSV_A.__doc__ = """SLM_Disp_ReadCSV_A(DWORD DisplayNumber, DWORD Flags, LPCSTR FileName)"""
...
SLM_Ctrl_WriteMT.__doc__ = """SLM_Ctrl_WriteMT(DWORD SLMNumber, DWORD TableNumber, DWORD MemoryNumber)"""
...
SLM_Ctrl_ReadMS.__doc__ = """SLM_Ctrl_ReadMS(DWORD SLMNumber, DWORD TableNumber, DWORD *MemoryNumber)"""
...
SLM_Ctrl_WriteMR.__doc__ = """SLM_Ctrl_WriteMR(DWORD SLMNumber, DWORD TableNumber1, DWORD TableNumber2)"""
...
SLM_Ctrl_ReadMR.__doc__ = """SLM_Ctrl_ReadMR(DWORD SLMNumber, DWORD *TableNumber1, DWORD *TableNumber2)"""
...
SLM_Ctrl_ReadEDO.__doc__ = """SLM_Ctrl_ReadEDO(DWORD SLMNumber, DWORD *deviceError, DWORD *optionError)"""
